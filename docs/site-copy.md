# Common Thread - Site Map & Copy

## Site Map
The website is a single-page application with a horizontal slide-based navigation structure.

1.  **01 / State of Mind** (Hero)
2.  **02 / Vision**
3.  **03 / Mechanism**
4.  **04 / Value**
5.  **05 / Leadership**
6.  **06 / Engagement** (Contact/Gateway)
...
**Supporting Content:**
**Human Focus**
> Automation isn't about removing the human; it's about removing the robot from the human. Focus on high-leverage creation.
>
...
**Button:** Read our latest insights →
